...
SITE_ID = 1
LOGIN_REDIRECT_URL = '/dashboard/'   # after login redirect
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'SCOPE': [
            ...
            'email',
            'openid',
            'https://www.googleapis.com/auth/calendar'   # enable later
        ],
        'AUTH_PARAMS': {
            'access_type': 'offline',   # ask Google to return refresh token
